        ...
        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <div class="form-group">
                ...
                <select id="mobil" name="mobil">
                    <option value="Sedan" <?= ($mobil == "Sedan") ? "selected" : "" ?>>Sedan</option>
                    <option value="SUV" <?= ($mobil == "SUV") ? "selected" : "" ?>>SUV</option>
                    <option value="Hatchback" <?= ($mobil == "Hatchback") ? "selected" : "" ?>>Hatchback</option>
                </select>
            </div>
